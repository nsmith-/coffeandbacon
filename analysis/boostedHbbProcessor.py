...
class BoostedHbbProcessor(processor.ProcessorABC):
    def __init__(self, corrections, debug=False, year='2017', skipPileup=False):
...
if __name__ == '__main__':
    ...
    processor_instance = BoostedHbbProcessor(corrections=corrections, debug=args.debug, year=args.year)
