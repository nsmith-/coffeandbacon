...
corrections['2016_muidweight_pt_abseta'] = evaluator['2016BF_muid_MC_NUM_LooseID_DEN_genTracks_PAR_pt_eta/efficienciesDATA/pt_abseta_DATA']
corrections['2016_muidweight_pt_abseta']._values *= lumiw2016_BCDEF
corrections['2016_muidweight_pt_abseta']._values += evaluator['2016GH_muid_MC_NUM_LooseID_DEN_genTracks_PAR_pt_eta/efficienciesDATA/pt_abseta_DATA']._values * lumiw2016_GH
corrections['2016_muidweight_abseta_pt_muidweightShift'] = evaluator['2016BF_muid_MC_NUM_LooseID_DEN_genTracks_PAR_pt_eta/efficienciesDATA/pt_abseta_DATA_error']
bf = evaluator['2016BF_muid_MC_NUM_LooseID_DEN_genTracks_PAR_pt_eta/efficienciesDATA/pt_abseta_DATA_error']._values 
gh = evaluator['2016GH_muid_MC_NUM_LooseID_DEN_genTracks_PAR_pt_eta/efficienciesDATA/pt_abseta_DATA_error']._values
...
corrections['2016_muisoweight_pt_abseta'] = evaluator['2016BF_muiso_LooseISO_LooseID_pt_eta/efficienciesDATA/pt_abseta_DATA']
corrections['2016_muisoweight_pt_abseta']._values *= lumiw2016_BCDEF
corrections['2016_muisoweight_pt_abseta']._values += evaluator['2016GH_muiso_LooseISO_LooseID_pt_eta/efficienciesDATA/pt_abseta_DATA']._values * lumiw2016_GH
corrections['2016_muisoweight_abseta_pt_muisoweightShift'] = evaluator['2016BF_muiso_LooseISO_LooseID_pt_eta/efficienciesDATA/pt_abseta_DATA_error']
bf = evaluator['2016BF_muiso_LooseISO_LooseID_pt_eta/efficienciesDATA/pt_abseta_DATA_error']._values 
gh = evaluator['2016GH_muiso_LooseISO_LooseID_pt_eta/efficienciesDATA/pt_abseta_DATA_error']._values
